...
class Upload extends CI_Controller {
    ...
    public function do_upload() {
        $upload_path_url = base_url() . 'assets/img/temp/';

        $config['upload_path'] = FCPATH . 'assets/img/temp/';
    ...
    public function deleteImage($file) {//gets the job done but you might want to add error checking and security
        $success = unlink(FCPATH . 'assets/img/temp/' . $file);
        $success = unlink(FCPATH . 'assets/img/temp/thumbs/' . $file);
