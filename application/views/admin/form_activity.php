...
//     echo validation_errors();
    ...
    <div class="form-group <?= (form_error('activity_subtitle')) ? ' has-error' : '' ?>">
        <label class="col-sm-3 control-label">ชื่อเรื่องรอง</label>
        <div class="col-sm-4">
            <?php echo $form['activity_subtitle']; ?>                 
        </div>
        <div class="col-sm-4" id="error">                
            <?php echo form_error('activity_subtitle', '<font color="error">', '</font>'); ?>
        </div>
    </div>
    ...
    <div class="well">
        ...
        <h3>รูปภาพอื่นๆ <small>จัดการก่อนทำการ บันทึก</small></h3>
        ...
        <div class="row fileupload-buttonbar">
            <div class="col-lg-7">
                ...
                <span class="btn btn-success fileinput-button">
                    ...
                    <span style="font-size: 20px">Add files...</span>
                    <input type="file" name="userfile" multiple>
                </span>
                <button type="submit" class="btn btn-primary start">
                    <i class="fa fa-upload fa-lg"></i>
                    <span style="font-size: 20px">Start upload</span>
                </button>
                <button type="reset" class="btn btn-warning cancel">
                    <i class="fa fa-ban fa-lg"></i>
                    <span style="font-size: 20px">Cancel upload</span>
                </button>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">คำแนะนำการใช้งานรูปภาพอื่นๆ</h3>
            </div>
            <div class="panel-body">
                <ul>
                    <li>จัดการรูปภาพอื่นๆ <strong>ก่อนบันทึก</strong> ข้อมูล</li>
