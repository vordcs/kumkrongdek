                ...
                <div class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix-top" role="complementary">
                    <ul class="nav bs-docs-sidenav">
                        <div class="list-group">
                            <a href="#history" class="list-group-item active">ประวัติความเป็นมา</a>
                            <a href="#vison" class="list-group-item">วิสัยทัศน์</a>
                            <a href="#popularity" class="list-group-item">ค่านิยม</a>
                            <a href="#culture" class="list-group-item">วัฒนธรรม</a>
                            <a href="#philosophy" class="list-group-item">ปรัชญา</a>
                            <a href="#objective" class="list-group-item">วัตถุประสงค์</a>
                            <a href="#relate" class="list-group-item">การดำเนินงาน</a>
                            <a href="#t1" class="list-group-item">เด็กที่ได้รับการสงเคราะห์</a>
                            <a href="#t2" class="list-group-item">การนำเด็กเข้ารับการสงเคราะห์</a>
                        </div>
<!--                        <li>
